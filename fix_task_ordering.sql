...
-- This script updates the reorder_template_items function and fixes negative task orders
...
-- Verify no negative orders remain
SELECT COUNT(*) as "Remaining negative orders" FROM step_tasks WHERE task_order < 0;
