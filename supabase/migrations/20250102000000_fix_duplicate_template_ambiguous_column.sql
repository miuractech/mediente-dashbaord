-- Fix for ambiguous column reference in duplicate_template function
-- This migration updates the duplicate_template function to remove the ambiguous template_id reference
...
-- Update the duplicate_template function to fix the ambiguous column reference
